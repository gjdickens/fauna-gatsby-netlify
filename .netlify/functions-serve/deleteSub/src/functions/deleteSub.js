...
var require_fauna = __commonJS({
  "functions/utils/fauna.js"(exports2) {
    init_src();
    exports2.faunaFetch = async ({ query, variables }) => {
      ...
      }).then((res) => res.json()).catch((err) => console.error(JSON.stringify(err, null, 2)));
    };
  }
});

// functions/utils/paddleCancel.js
var require_paddleCancel = __commonJS({
  "functions/utils/paddleCancel.js"(exports2) {
    init_src();
    exports2.paddleCancel = async (subID) => {
...
// functions/deleteSub.js
var { faunaFetch } = require_fauna();
var { paddleCancel } = require_paddleCancel();
...
//# sourceMappingURL=deleteSub.js.map
